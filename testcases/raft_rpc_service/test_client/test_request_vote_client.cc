 ...
 * File Name: test_request_vote_client.cc
...
void test_client() {
  ...
  ::RequestVoteRequest rpc_req;
  ::RequestVoteReply rpc_res;

  std::cout << "Send to tinyrpc server " << addr->toString() << ", request body: [" << rpc_req.ShortDebugString() << "]" << std::endl;
  stub.RequestVote(&rpc_controller, &rpc_req, &rpc_res, NULL);
